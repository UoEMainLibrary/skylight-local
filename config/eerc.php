...
if(ENVIRONMENT == 'development') {
    if (strpos($_SERVER['HTTP_HOST'], "localhost") !== false) {
        ...
        $config['skylight_link_url'] = 'http://lac-archivesspace-live5.is.ed.ac.uk:8081';
    } else if (strpos($_SERVER['HTTP_HOST'], "test") !== false) {
        $config['skylight_ga_code'] = '';
        $config['skylight_solrbase'] = 'http://lac-archivesspace-live5.is.ed.ac.uk:8983/';
        $config['skylight_link_url'] = 'http://lac-archivesspace-live5.is.ed.ac.uk:8081';
        //$config['skylight_solrbase'] = 'http://lac-archivesspace-live5.is.ed.ac.uk:9123/';
...
$config['skylight_archivesspace_url'] = 'http://lac-archivesspace-live5.is.ed.ac.uk:8089';
