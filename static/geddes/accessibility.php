<html>
    <h1>Accessibility statement for <a href="https://collections.ed.ac.uk/geddes">The Patrick Geddes Archives website</a></h1>
    ...
    <p>This accessibility statement applies to  <a href="https://collections.ed.ac.uk/geddes">https://collections.ed.ac.uk/geddes</a></p>
    ...
    <ul>
        ...
        <li>not all non-text content presented to users has alternative text and text is sometimes displayed as an image;</li>
        ...
        <li>the image carousel on the homepage does not have control buttons to pause or stop or click to ‘previous’ or ‘next’ images.</li>
    </ul>
    ...
    <ul>
        ...
        <li>Information, structure and relationships conveyed through presentation cannot always be programmatically determined. This includes some missing < h1 > tags
            <ul>
    ...
    <p><strong>This statement was first prepared on 7th August 2022 and it was last reviewed on 21st January 2023.</strong></p>
    ...
    <p>using the automated tool LittleForest and manual testing. The site was tested on a PC, using Mozilla Firefox (91.7.1esr), Microsoft Edge (99.0.1150.55), Google Chrome (99.0.4844.84), and Internet Explorer (IE) (19043.1586) browsers for comparative purposes. We test on Firefox, Chrome and Edge to ensure breadth and variety.</p>
