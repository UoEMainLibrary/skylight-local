<html>
    <h1>Accessibility statement for <a href="https://collections.ed.ac.uk/eerc">Regional Ethnology of Scotland Website</a></h1>
    ...
    <p>This accessibility statement applies to: <a href="https://collections.ed.ac.uk/eerc">https://collections.ed.ac.uk/eerc</a></p>
    ...
    <p>This website is run by the Library and University Collections Directorate which is part of Information Services Group at the University of Edinburgh. We want as many people as possible to be able to use this website. For example, that means you should be able to:</p>
        <ul>
            ...
            <li>navigate to most of the website using just a keyboard;</li>
            <li>navigate most of the website using speech recognition software;</li>
            <li>listen to most of the website using a screen reader (including the most recent versions of JAWS, NVDA and VoiceOver);</li>
            <li>use the website without encountering any time limits;</li>
            <li>use the website without encountering any moving, scrolling or flashing text.</li>
        </ul>
        ...
        <ul>
            ...
            <li>you may not be able to access all content by using the keyboard alone and there is a keyboard trap when clicking the ‘more options’ button on audio files;</li>
        ...
        <ul>
            ...
            <li>Not all prerecorded audio-only or video-only media will have alternative media that presents equivalent information e.g. audio track with description of the action in a video with no sound
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#audio-only-and-video-only-prerecorded">1.2.1 – Audio-only and Video-only (Prerecorded)</a></li>
                </ul>
            </li>
            <li>Not all video holds captions, subtitles that identify all speakers, or note other significant sounds (e.g. laughter)
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#captions-prerecorded">1.2.2 - Captions (Prerecorded)</a></li>
                </ul>
            </li>
            ...
            <li>Some content in the sidebar is not read sequentially by screen readers
                <ul>
            ...
            <li>Information is conveyed as an image of text rather than as text itself, making it not compatible with screen readers and other assistive technology and is not fully customisable
                <ul>
            ...
            <li>Content cannot be presented without requiring scrolling in two dimensions to 200% with reflow
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#reflow">1.4.10 - Reflow</a></li>
                </ul>
            </li>
            <li>Tooltips are available using mouse hover but not via keyboard
                <ul>
            ...
            <li>Keyboard focus cannot be moved away from the ‘more options’ button on the audio files once navigated to via keyboard
                <ul>
            ...
            <li>Link purpose is not always clear and some adjacent links go to the same URL
                <ul>
            ...
            <li>Screen readers and voice recognition software are not able to identify some parts of the page
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#name-role-valuet">4.1.2 - Name, Role, Value</a></li>
                </ul>
            </li>
            <li>Not all our PDF’s and Word documents meet accessibility standards documents
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#non-test-content">1.1.1 - Non-text Content</a></li>
        ...
        <p>“These Regulations do not apply to the following content of a website or mobile application of a public sector body—
        ...
        <p><a href="https://www.ed.ac.uk/estates/buildings-information/disability">AccessAble Information</a>.</p>
        <p><strong>PDFs</strong></p>
        <p>Many of our older PDFs do not meet accessibility standards – for example, they may not be structured so they are accessible to a screen reader. This does not meet WCAG 2.1 success criterion 4.1.2 (name, role, value).</p>
        <p><a href="https://www.w3.org/TR/WCAG21/#name-role-value">WCAG 2.1 success criterion 4.1.2 (name, role, value)</a></p>
        <p>Some of our PDFs are essential to accessing information on the site. For example, several of the audio interview files have corresponding transcripts in PDF form. We will try to ensure any new PDFs or Word documents we publish will meet accessibility standards.</p>
        <p><a href="https://www.legislation.gov.uk/uksi/2018/952/regulation/4/made">Regulations for PDF's</a></p>
        ...
        <p><strong>This statement was prepared on10th September 2020. It was last reviewed on 3rd March 2023.</strong></p>
        <p>This website was first tested by the Digital Library & Development team in September 2020 and reviewed on 15th September 2021 and again on 3rd March 2023. The testing was initially carried out by The University of Edinburgh Library and University Collections Digital Library Development team using the automated <a href="https://wave.webaim.org/">Wave WEBAIM</a> and <a href="https://littleforest.co.uk/">Little Forest</a> testing tool. The testing in October 2022 included full manual as well as automated testing.</p>
        <p>This website was last manually tested by the Digital Library team, Library and University Collections, University of Edinburgh in March 2023. This was primarily using Mozilla Firefox (91.7.1esr), Microsoft Edge (99.0.1150.55) and Google Chrome (99.0.4844.84), browsers for comparative purposes.</p>
