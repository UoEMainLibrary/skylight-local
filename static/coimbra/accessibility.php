...
<ul>
    ...
    <li>content may not be fully compatible with screen readers</li>
    <li>not all colour contrasts meet recommended guidance</li>
    <li>tooltips are not present for all icons</li>
    <li>it is not always clear where a user has reached using the keyboard alone</li>
    <li>page titles may not clearly describe their purpose</li>
</ul>
...
<ul>
    <li>Not all our non-text content has a text alternative
        <ul>
...
<p>This website was last tested on 7<sup>th</sup> August 2020. The test was carried out by the University Library and Collections Digital Library team using the automated Little Forest tool. The website is scheduled for manual testing by July 2022.</p>
<p>All pages were run through LittleForest.</p>
