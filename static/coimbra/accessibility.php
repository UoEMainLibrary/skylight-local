...
<div class="col-md-9 col-sm-9 col-xs-12">
    <div class="content byEditor">
        ...
        <ul>
            ...
            <li>navigate most of the website using just a keyboard (not the map section)</li>
        ...
        <ul>
            ...
            <li>some content moves, blinks or scrolls without a mechanism to pause, stop or hide;</li>
            <li>item titles only appear on mouse hover over their images;</li>
            <li>it is not possible to use the site in portrait mode because users can become stuck in the image viewer window and are unable to scroll or click out;</li>
            <li>not all content is compatible with screen readers or voice recognition software;</li>
            <li>some text is displayed as an image of text.</li>     
        </ul>
        ...
        <ul>
            ...
            <li>Colour is used as the only visual means of conveying information, indicating an action, prompting a response, or distinguishing a visual element
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#use-of-color">1.4.1 - Use of Color</a></li>
                </ul>
            </li>
            ...
            <li>Moving or scrolling information cannot be paused, stopped or hidden
                <ul>
        ...
        <p><strong>This statement was prepared on 7th August 2020. It was last reviewed on 2nd March 2023.</strong></p>
        <p>This website was first tested on 7th August 2020,reviewed on 15th September 2021 and then again in March 2023. The testing was carried out by The University Library and University Collections Digital Library Development team using the automated <a href="https://wave.webaim.org/">Wave WEBAIM</a> and <a href="https://littleforest.co.uk/">Little Forest</a> testing tool.</p>
        <p>This website was last manually tested by the Library and University Collections Digital Library team, University of Edinburgh <strong>on the 4th July 2022</strong> following on from previous automated testing of the system the previous year. This was primarily using the Google Chrome (100.0.4896.127), Mozilla Firefox (91.8.0esr), Internet Explorer (11.0) and Microsoft Edge (100.0.1185.39) browsers for comparative purposes. </p>
