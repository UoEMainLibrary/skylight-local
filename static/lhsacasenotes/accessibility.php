...
<head>
  ...
  <style type="text/css">
		#content, .tab-heading, .navbar, footer, header, .col-sidebar {
			display: none;
		}
    ...
    @page { size: 21cm 29.7cm; margin: 2.54cm }
		...
		h1 { font-size: 24pt; line-height: 1.01}
		h2 { font-size: 20pt; }
		h3 { font-size: 16pt; }
...
<h1>Accessibility
statement for the <a href="https://collections.ed.ac.uk/lhsacasenotes/">Medical records revived: Case Note Catalogues at Lothian Health Services Archive</a></h1>
</p>
<p>
...
<p><a href="https://collections.ed.ac.uk/lhsacasenotes/">https://collections.ed.ac.uk/lhsacasenotes/</a>
</p>
...
<ul>
<li>Colour contrast does not always meet required standards</li>
<li>Most images do not have any alternative text</li>
<li>Magnification beyond 175% leads to loss of content</li>
...
<li>Lack of a “skip to main content” button</li>
<li>Users are not alerted when some hyperlinks open new tab / window</li>
<li>Search button does not have discernible text</li>
<li>It is not always clear where you have keyboard navigated too</li>
<li>It is not possible to view the site in landscape and portrait.</li>
...
<ul><li>Some content is lost when viewing in portrait mode on mobile devices</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#orientation">1.3.3 – Orientation</a></p>

<ul><li>Some links are conveyed by colour alone<p></li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#use-of-color">1.4.1 – Use of Color</a></p>

<ul><li>Insufficient colour contrast </li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#contrast-minimum">1.4.3 – Contrast (Minimum)</a></p>

<ul><li>There are instances of text as image<p></li></ul>
...
<ul><li>Website lacks a “skip to main content” option<p></li></ul>
...
<ul><li>Inadequate focus indicator visibility hinders ease of keyboard operability<p></li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#focus-visible">2.4.7 – Focus Visible</a></p>

<ul><li>Some actions do not alert the user before opening a new tab / window</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#on-input">3.2.2 – On Input</a></p>

<ul><li>Content is not robust enough that it can be interpreted by a wide variety of user agents, including assistive technologies e.g., buttons do not all have discernible text<p></li></ul>
...
<p>There are some heritage collection items on the site such as the Tuberculosis diagram on the page:</p>
<a href="https://collections.ed.ac.uk/lhsacasenotes/tuberculosis">Tuberculosis measures </a>
<p>These have maintained as they are as permitted by the <a href="https://www.legislation.gov.uk/uksi/2018/952">Public Sector Bodies Website and Mobile Application Regulations (No. 2) 2018.</a></p>
<p>As such they contain text as an image.</p>
<p>
...
complete solution or significant improvement will be in place by February 2026.
<p>
...
<p><b>This statement was prepared on 15th September 2021. It was last reviewed on 11th March 2025.</b></p> 

<p><b>The website was last tested on 20th February 2025. The
