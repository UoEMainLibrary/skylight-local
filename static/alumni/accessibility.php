...
<p><a href="https://collections.ed.ac.uk/alumni">https://collections.ed.ac.uk/alumni</a>
</p>
...
<ul>
<li>Change colours and contrast levels</li>
...
<li>Some images do not have any or informative alternative text</li>
<li>Some new tab/windows and pop-ups open without alerting the user</li>
<li>Not all hyperlinks are formatted correctly</li>
<li>Hyperlinks are only indicated by a different colour</li>
<li>Headings are not properly coded and some heading levels are skipped</li>
<li>Some tooltips cannot be reached by keyboard or assistive software</li>
<li>Keyboard tabbing order does not always follow a logical order</li>
...
<!-- Change the {{nonComDesc}} to whatever the statement is supposed to say -->
	...
	<ul>
	<li>Not all non-text items presented to users has alternative text
		<p><a href="https://www.w3.org/TR/WCAG22/#non-text-content">1.1.1 - Non Text Content</a></p></li>
		</ul>
	
<p>
</p>
    <ul>
	<li>Keyboard focus order could be improved
		<p><a href="https://www.w3.org/TR/WCAG22/#meaningful-sequence">1.3.2 - Meaningful Sequence</a></p>
		<p><a href="https://www.w3.org/TR/WCAG22/#focus-order">2.4.3 - Focus Order</a></p></li>
	</ul>
<p>
</p>
    <ul>
	<li>Some hyperlinks are conveyed with colour only
		<p><a href="https://www.w3.org/TR/WCAG22/#use-of-color">1.4.1 - Use of Colour</a></p></li>
	</ul>
<p>
</p>
    <ul>
	<li>Reflow is not operational up to 400%
		<p><a href="https://www.w3.org/TR/WCAG22/#reflow">1.4.10 - Reflow</a></p></li>
	</ul>
<p>
</p>

    <ul>
	<li>Not all tooltips are fully accessible
		<p><a href="https://www.w3.org/TR/WCAG22/#content-on-hover-or-focus">1.4.13 - Content on Hover or Focus</a></p></li>
	</ul>
<p>
</p>
    <ul>
	<li>Some links do not contain meaningful hypertext to inform the user of their target location
		<p><a href="https://www.w3.org/TR/WCAG22/#link-purpose-in-context">2.4.4 - Link Purpose (In Context)</a></p></li>
	</ul>
<p>
</p>

    <ul>
	<li>Some heading levels are missed, which affects screen reader software
		<p><a href="https://www.w3.org/TR/WCAG22/#headings-and-labels">2.4.6 - Headings and Labels</a></p></li>
	</ul>
<p>
</p>
    <ul>
	<li>Some hyperlinks open link in new tab / window, and some pop-ups do not alert the user this will happen
		<p><a href="https://www.w3.org/TR/WCAG22/#on-input">3.2.2 - On Input</a></p></li>
	</ul>
<p>
</p>
    <ul>
	<li>The website is not fully compatible with assistive software e.g. not all form labels have labels
		<p><a href="https://www.w3.org/TR/WCAG22/#name-role-value">4.1.2 - Name, Role, Value</a></p></li>
	</ul>
<p>
</p>
...
<p>
We are working towards solving these problems and expect significant improvements by September 2025. The site is fully within our control.
</p>
<p>
...
complete solution or significant improvement will be in place by October 2025. The site is completely within our control.
</p>
<p>
...
<p><b>This statement was prepared on 20th September 2021. It was last reviewed on 14th November 2024.</b></p>
<p>

</p>
<p><b>The website was last tested on 4th November 2024. The
...
<p>
    ...
    <ul>
	<li>Colour contrast issues have been resolved to meet WCAG 2.2 AA standards.
		<p><a href="https://www.w3.org/TR/WCAG22/#contrast-minimum">1.4.3 - Contrast (Minimum)</a></p></li>
	</ul>
<p>
</p>

    <ul>
	<li>Skip to main content button has been added on each page
		<p><a href="https://www.w3.org/TR/WCAG22/#bypass-blocks">2.4.1 - Bypass Blocks</a></p></li>
	</ul>
<p>
</p>
	
 <ul>
	<li>Selection displays that use high contrast outline have been added
...
<p>
  ...
  <ul>
	<li>Logos are examples of text as an image but they do contain alternative text
		<p><a href="https://www.w3.org/TR/WCAG22/#images-of-text">1.4.5 - Images of Text</a></p></li>
	</ul>
