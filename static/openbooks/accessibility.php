<html>
<h1>Accessibility statement for <a href="https://openbooks.is.ed.ac.uk/">Open Books</a> website</h1>
...
<p><a href="https://openbooks.is.ed.ac.uk/">Open Books</a> - <a href="https://openbooks.is.ed.ac.uk/">https://openbooks.is.ed.ac.uk/</a> is a website hosted by the University of Edinburgh Library on behalf of the University of Edinburgh. This collection is compiled from readers&rsquo; orders for scans, principally in black and white and some in colour. The images that have been created by the University's Digital Imaging Unit are freely accessible to all.</p>
...
<ul>
    ...
    <li>The system may not be fully compatible with screen readers e.g. a screen reader may not be able to determine what the content is and how it relates to other content</li>
    <li>The colours on are pages may not meet current colour contrast recommendations</li>
    <li>All our web pages may not have a title that clearly describes their purpose</li>
    <li>User interface elements may not be compatible with assistive technology</li>
    <li>Not all our PDF&rsquo;s are fully accessible</li>
</ul>
...
<ul>
    <li>Not all non-text items have text alternatives
        <ul>
    ...
    <li><a href="https://www.w3.org/TR/WCAG21/#dfn-web-page-s">Web pages</a> do not all have titles that describe topic or purpose.
        <ul>
...
<p>At this time we are not claiming that any content on the website is out of scope.</p>
...
<p><strong>This statement w</strong><strong>as prepared on 15<sup>th</sup> September 2021. It was last reviewed on 15<sup>th</sup> September 2021</strong>.</p>
