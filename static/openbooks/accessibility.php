<html>
    <h1>Accessibility statement for <a href="https://openbooks.is.ed.ac.uk/">Open Books</a></h1>
    ...
    <p>This accessibility statement applies to  <a href="https://openbooks.is.ed.ac.uk/">https://openbooks.is.ed.ac.uk/</a></p>
    ...
    <ul>
        ...
        <li>some content may be distorted or lost when you change the size of the browser window and at certain levels of magnification;</li>
        <li>content does not reflow when magnified so the user has to scroll horizontally as well as vertically </li>
        ...
        <li>some parts of the site especially the PDFs may not be fully compatible with screen reader software;</li>
        <li>some tooltips do not appear when using the keyboard and / or are not hoverable;</li>
    ...
    <ul>
        ...
        <li>Content cannot be presented without the user scrolling in two dimensions beyond 175%, with some content being lost altogether
            <ul>
                <li><a href="https://www.w3.org/TR/WCAG21/#reflow">1.4.10 - Reflow</a></li>
            </ul>
        </li>
        <li>Some tooltips do not appear when using the keyboard to navigate
            <ul>
    ...
    <p><span style="font-weight:bold;">May 2024</span> - We have aimed to improve accessibility of the custom PDF reader by adding a zoom feature as well as the ability to quickly navigate to any page by using a textbox.</p>
</html>