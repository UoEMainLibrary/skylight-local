...
<h1>Accessibility
Statement for the <a href="https://openbooks.is.ed.ac.uk/">Open Books website</a></h1>
</p>
<p>
...
<p><a href="https://openbooks.is.ed.ac.uk/">https://openbooks.is.ed.ac.uk/</a>
</p>
...
<ul>
<li>Some images, including the homepage banner, do not have meaningful alternative text</li>
<li>Some information is conveyed by color only e.g. links</li>
<li>Text and layout do not always reflow properly when zoomed in, requiring horizontal scrolling at higher magnifications</li>
<li>The site is not fully compatible with browser customisation</li>
<li>Some form elements and dropdowns lack clear labels or accessible names</li>
<li>Tooltips in the PDF viewer are not accessible to screen readers or keyboard users</li>
<li>Dropdown menus occasionally obscure other content when expanded</li>
<li>Links do not have meaningful hypertext</li>
<li>Embedded PDFs are not fully accessible for users of assistive technologies</li>
...
<ul><li>Not all images, including the home banner, have meaningful or descriptive alternative text</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#non-text-content">1.1.1 – Non-text Content</a></p>

<ul><li>Some information is conveyed only by colour e.g. links</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#use-of-color">1.4.1 – Use of Colour</a></p>

<ul><li>Content does not reflow beyond 200% zoom without horizontal scrolling</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#reflow">1.4.10 – Reflow</a></p>

<ul><li>Several hyperlinks are presented as naked URLs or are repetitive and lack meaningful hypertext</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#link-purpose-in-context">2.4.4 – Link Purpose (In Context)</a></p>

<ul><li>Some content becomes partially obscured when dropdown menus (e.g. “Advanced Search”) are expanded</li></ul>
...
<ul><li>Content is not robust enough that it can be interpreted by a wide variety of user agents, including assistive technologies e.g. Form elements, including the search field and select elements (e.g. the “Advanced Search” dropdown), do not have accessible names and certain elements use unsupported ARIA attributes</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#name-role-value">4.1.2 – Name, Role, Value</a></p>

<ul><li>There are embedded PDFs that are not accessible</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#non-text-content">1.1.1 – Non-text Content</a></p>
<p><a href="https://www.w3.org/TR/WCAG22/#name-role-value">4.1.2 – Name, Role, Value</a></p>

<p>At this time, we believe all items are within our control. Unless specified otherwise, a complete solution, or significant improvement, will be in place for those items within our control by November 2026. We believe the site to be fully in our control.
</p>
<p>
...
complete solution or significant improvement will be in place by November 2026.  We believe the site at this time is fully under our control.
<p>
...
<p><b>This statement was first prepared on 7th August 2020. It was last reviewed on 27th October 2025.</b></p> 

<p><b>This website was last tested on 29th September 2025. The
...
<ul><li>All colour contrast issues have been resolved to meet WCAG 2.2 AA standards (08/08/2024)</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#contrast-minimum">1.4.3 – Contrast (Minimum)</a></p>

<ul><li>Removed the transparency of the text over the image (08/08/2024)</li></ul>

<ul><li>Added a skip to main content button on each page (08/08/2024)</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#bypass-blocks">2.4.1 – Bypass Blocks</a></p>

<ul><li>Increased font size to at least 12pt (08/08/2024)</li></ul>
<p>
</p>
</body>
</html>