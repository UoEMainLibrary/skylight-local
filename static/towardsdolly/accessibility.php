...
<h1>Accessibility
statement for <a href="https://collections.ed.ac.uk/towardsdolly/">Towards Dolly</a></h1>
</p>
<p>
...
<p><a href="https://collections.ed.ac.uk/towardsdolly/">https://collections.ed.ac.uk/towardsdolly/</a>
</p>
...
<li>Navigate most of the site using voice recognition software (e.g. Dragon NaturallySpeaking)
<li>Experience no time limits when using the website</li>
<li>Use the site without encountering any scrolling, flashing or moving text
</ul>
<p>
...
<ul>
<li>Search bar lacks a label</li>
<li>Some text is presented as an image</li>
<li>Some links lack underlines for easy visual identification</li>
<li>Most images do not have any alternative text</li>
<li>Videos on the page lacks transcripts, captions or audio descriptions</li>
<li>Links in the main body lack hypertext about where it leads</li>
<li>Users are not alerted when some hyperlinks open new tab / window</li>
<li>Reflow is not operational, requiring horizontal scrolling after 200% magnification</li>
<li>Keyboard navigation order in the navigation bar at the top of the page is in reverse</li>
<li>Lack of a “skip to main content” button makes navigation using screen readers or dictation software difficult</li>
<li>Video playback controls can result in being unable to scroll using the keyboard</li>
...
<ul><li>Not all non-text items have sufficient alternative text</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#non-text-content">1.1.1 - Non Text Content</a></p>


<ul><li>Video content lacks accurate captions</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#captions-prerecorded">1.2.2 – Captions (Prerecorded)</a></p>


<ul><li>Video content lacks audio descriptions</li></ul>
...
<ul><li>Navigation order at the top of the page is not necessarily logical</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#meaningful-sequence">1.3.2 – Meaningful Sequence</a></p>


<ul><li>Some links are conveyed by colour alone</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#use-of-color">1.4.1 – Use of Color</a></p>


<ul><li>There are instances of text as image</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#images-of-text">1.4.5 – Images of Text</a></p>


<ul><li>Content cannot be presented without loss of information or functionality, and requires scrolling in two dimensions</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#reflow">1.4.10 – Reflow</a></p>


<ul><li>Website lacks a “skip to main content” option</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#bypass-blocks">2.4.1 – Bypass Blocks</a></p>


<ul><li>Some links lack meaningful hypertext regarding target location</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#link-purpose-in-context">2.4.4 – Link Purpose (In Context)</a></p>


<ul><li>Some hyperlinks do not alert the user before opening in a new tab / window</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#on-input">3.2.2 - On Input</a></p>


<ul><li>Input errors in the search bar lead to error messages through page redirects</li></ul>
<p><a href="https://www.w3.org/TR/WCAG22/#error-identification">3.3.1 – Error Identification</a></p>

<ul><li>Content is not robust enough that it can be interpreted by a wide variety of user agents, including assistive technologies e.g., some form elements lack labels</li></ul>
...
improvements by January 2026. The site is fully within our control.</p>
<p>
...
complete solution or significant improvement will be in place by January 2026.
<p>
...
<p><b>This statement was prepared in 15th September 2021. It was last reviewed on 28th January 2025.</b></p>

<p><b>The website was last tested on 2nd December 2024. The
...
<h2>Change Log</h2
<p>
Since our initial report, we have undertaken more extensive manual testing with assistive software to get a better understanding of
the accessibility issues on this website. This section will receive updates as and when accessibility improvements are made to the website.</p>
