<div class="content" id="static-exhibition">
    <div class="content byEditor" id="privacy-container">
        <h1 alt="exhibition title">Accessibility statement for University of Edinburgh Library Exhibitions Website</h1>
        ...
        <h1 alt="exhibition title">How accessible this website is</h1>
        <p id="" class="privacy-p" alt="exhibitions accessability details">
        ...
        <h1 alt="exhibition title">What to do if you cannot access parts of this website</h1>
        <p id="" class="privacy-p" alt="exhibitions accessability details">
        ...
        <h1 alt="exhibition title">Enforcement procedure</h1>
        <p id="" class="privacy-p" alt="exhibitions accessability details">
        ...
        <h1 alt="exhibition title">Non accessible content</h1>
        <p id="" class="privacy-p" alt="exhibitions accessability details">
        ...
        <h1 alt="exhibition title">How we tested this website</h1>
        <p id="" class="privacy-p" alt="exhibitions accessability details">
        ...
        <h1 alt="exhibition title">What we’re doing to improve accessibility</h1>
        <p id="" class="privacy-p" alt="exhibitions accessability details">
        ...
        <h1 alt="exhibition title">Information Services and accessibility</h1>
        <p id="" class="privacy-p" alt="exhibitions accessability details">
