<html>
    <h1>Accessibility statement for <a href="https://collections.ed.ac.uk/iconics">Iconic websites</a></h1>
    ...
    <p>This accessibility statement applies to  <a href="https://collections.ed.ac.uk/iconics">https://collections.ed.ac.uk/iconics</a></p>
    ...
    <ul>
        ...
        <li>zoom in up to 500% (but without reflow);</li>
        ...
        <li>the user will not encounter any flashing, scrolling or moving text.</li>
    </ul>
    ...
    <ul>
        ...
        <li>It can sometimes be hard to tell where you have navigated to using a keyboard and tabbing round the site does not follow a logical oreder;</li>
    ...
    <ul>
        ...
        <li>There are instances of text appearing over images on hover on the main page
            <ul>
                <li><a href="https://www.w3.org/TR/WCAG21/#on-focus">3.2.1 – On Focus</a></li>
            </ul>
        </li>
    ...
    <p><strong>This statement was prepared on 7th August 2020. It was last reviewed on 18thth January 2023.</strong></p>
    <p>This website was first tested on 7th August 2020, reviewed on 15th September 2021 and again on 18th January 2023. The testing was initially carried out by The University of Edinburgh Library and University Collections Digital Library Development team using the automated <a href="https://wave.webaim.org/">Wave WEBAIM</a> and <a href="https://littleforest.co.uk/">Little Forest</a> testing tool.</p>
    <p>This website was last manually tested by the Digital Library team, Library and University Collections, University of Edinburgh in September 2022 following on from previous automated testing of the system the previous two years. This was primarily using Mozilla Firefox (91.7.1esr), Microsoft Edge (99.0.1150.55), Google Chrome (99.0.4844.84), and Internet Explorer (IE) (19043.1586) browsers for comparative purposes.</p>
