<html>
    <h1>Accessibility statement for <a href="http://www.fairbairn.ac.uk/">Fairbairn</a> website</h1>
    ...
    <p>This accessibility statement applies to  <a href="http://www.fairbairn.ac.uk/">http://www.fairbairn.ac.uk/</a></p>
    <p><a href="http://www.fairbairn.ac.uk/">Fairbairn</a> (http://www.fairbairn.ac.uk/) is a website hosted by the University of Edinburgh Library on behalf of the University of Edinburgh. It holds collection information and images from W. Ronald D. Fairbairn including his personal library, held by Edinburgh University Library and his papers, diaries and correspondence held in the National Library of Scotland.</p>

    <p><strong>We want as many people as possible to be able to use our website. For example, this means you should be able to:</strong></p>
    <ul>
        <li>using your browser settings, change colours, contrast levels and fonts</li>
        <li>zoom in up to 500%</li>
        <li>navigate most of the website using just a keyboard</li>
        <li>listen to most of the website using a screen reader (including the most recent versions of JAWS, and NVDA)</li>
        <li>interact with the website without encountering any time limits</li>
        <li>interact with the website without encountering any flashing, moving or scrolling text.</li>
    </ul>
    ...
    <ul>
        <li>Keyboard navigation does not follow a logical order e.g. the footer is read before the sidebar menu</li>
        <li>It could be clearer to keyboard users where they have navigated to on a page</li>
        <li>There is no skip to main content option </li>
        <li>Pages do not reflow above 200%</li>
        <li>Users are not alerted when a link will open a new browser tab</li>
        <li>Link text does not always give a clear indication of link purpose</li>
        <li>There are some cases where text is an image</li>
        <li>Not all colour contrasts meet recommend colour contrast guidance </li>
    ...
    <ul>
        <li>By using the IS Helpline online contact form: <a href="https://www.ishelpline.ed.ac.uk/forms/">IS Helpline contact form</a></li>
        <li>Or phoning: +44 (0)131 651 5151</li>
        <li>Or email: <a href="mailto:Information.systems@ed.ac.uk">Information.systems@ed.ac.uk</a>
    ...
    <ul>
        ...
        <li>Keyboard navigation through pages does not always follow a logical sequence
            <ul>
                <li><a href="https://www.w3.org/TR/WCAG21/#focus-order">2.4.3 Focus Order</a></li>
            </ul>
        </li>
        <li>Link purpose is not always clear
            <ul>
    ...
    <p>We will continue to address the accessibility issues highlighted, either through delivery of a solution or suitable workaround. Unless specified otherwise, a complete solution or significant improvement will be in place for those items within our control by March 2024.</p>
    <p>Whilst we are in the process of resolving these accessibility issues, or where we are unable, we will ensure reasonable adjustments are in place to make sure no user is disadvantaged. As changes are made, we will continue to review accessibility and retest the accessibility of this website.</p>

    <h2>Preparation of this accessibility statement</h3>
    <p><strong>This statement was prepared on 20th February 2023. It was last reviewed on 20th February 2023.</strong></p>
    <p>This website was first tested in August 2020 and last tested in June 2022.</p>
    <p>The testing was carried out by The University Library and University Collections Digital Library Development team using the automated <a href="https://wave.webaim.org/">Wave WEBAIM</a> and <a href="https://littleforest.co.uk/">Little Forest</a> testing tool.</p>
    <p>This website was last tested by the Library and University Collections Digital Library team, University of Edinburgh on the 4th July 2022 using automated and manual methods (following on from previous automated testing of the system the previous year.) This was primarily using the Google Chrome (100.0.4896.127), Mozilla Firefox (91.8.0esr), and Microsoft Edge (100.0.1185.39) browsers for comparative purposes.</p>
