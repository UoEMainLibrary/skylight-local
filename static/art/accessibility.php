<div class="container">
    <div class="content byEditor">
        <h2>https://collections.ed.ac.uk/art</h2>
        <p>&nbsp;</p>
        ...
        <ul>
            ...
            <li>It is not possible to navigate by keyboard only to all content</li>
        ...
        <p>If you need information on this website in a different format like accessible PDF, large print, audio recording or braille please contact the website team by emailing <a href="mailto:is-crc@ed.ac.uk" alt-text="mail to CRC" title="mail to CRC">is-crc@ed.ac.uk</a> or by phoning +44(0)131 650 8379  or by writing to us at:</p>
        ...
        <p>Email: <a href="mailto:is-crc@ed.ac.uk" alt-text="mail to CRC" title="mail to CRC">is-crc@ed.ac.uk</a></p>
        ...
        <p>Technical information about this website&rsquo;s accessibility</p>
        ...
        <ul>
            ...
            <li>Information is conveyed as an image of text rather than as text itelf so that it's not compatible with screen readers and other assistive technology. It can also sometimes we hard to tell where you have tabbed too.
                <ul>
            ...
            <li>Not all prerecorded audio-only or video-only media will have alternative media that presents equivalent information e.g. audio track with description of the action in a video with no sound
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#audio-only-and-video-only-prerecorded">2.1 <strong>-&nbsp; </strong>Audio-only and Video-only (Prerecorded)</a></li>
                </ul>
            </li>
            <li>Not all video will have subtitles or subtitles that identify all speakers as well as noting other significant sounds e.g. laughter
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#captions-prerecorded">2.2 - Captions (Prerecorded)</a></li>
                </ul>
            </li>
            <li>Not all our PDF&rsquo;s and Word documents meet accessibility standards
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#non-text-content">1.1 - Non-text Content</a></li>
                    <li><a href="https://www.w3.org/TR/WCAG21/#multiple-ways">4.5 - Multiple Ways</a></li>
                    <li><a href="https://www.w3.org/TR/WCAG21/#meaningful-sequence">3.2 - Meaningful Sequence</a></li>
                    <li><a href="https://www.w3.org/TR/WCAG21/#images-of-text">4.5 - Images of Text</a></li>
                </ul>
            </li>
