<html>
    <h1>Accessibility statement for <a href="https://collections.ed.ac.uk/mimed">Musical Instruments Museums Edinburghwebsite</a></h1>
    ...
    <p>This accessibility statement applies to  <a href="https://collections.ed.ac.uk/mimed">https://collections.ed.ac.uk/mimed</a></p>
    ...
    <ul>
        ...
        <li>you can magnify content up to 250%;</li>
    ...
    <ul>
        ...
        <li>not all icons have tooltips and these are available via mouse hover but not when using the keyboard;</li>
        ...
        <li>you cannot magnify the site above 250% without some distortion;</li>
        ...
        <li>some parts of the site are not fully compatible with voice recognition software.</li>
    </ul>
    ...
    <ul>
        ...
        <li>Information, structure and relationships conveyed through presentation cannot always be programmatically determined. This includes missing < h1 > tags, multiple < h1 > tags on a single page and skipping heading levels (i.e. an < h1 > and < h3 > exist on a page but no < h2 > tag).
            <ul>
        ...
        <li>Some content is not read sequentially by screen readers
            <ul>
        ...
        <li>Where this is moving content this cannot be paused or stopped by the end user
            <ul>
        ...
        <li>Where it is possible to give error suggestions these are not provided
            <ul>
    ...
    <p><strong>This statement was first prepared on 7th August 2020. It was last reviewed on 23th February 2023.</strong></p>
    <p>This website was first tested on 7th August 2020, reviewed on 15th September 2021 and then again on 23rd February 2022. The testing was initially carried out by The University of Edinburgh Library and University Collections Digital Library Development team using the automated <a href="https://wave.webaim.org/">Wave WEBAIM</a> and <a href="https://littleforest.co.uk/">Little Forest</a> testing tool.</p>
    <p>This website was last manually tested by the Digital Library team, Library and University Collections, University of Edinburgh in February 2023. This was primarily using Mozilla Firefox (91.7.1esr), Microsoft Edge (99.0.1150.55) and Google Chrome (99.0.4844.84), browsers for comparative purposes. </p>
