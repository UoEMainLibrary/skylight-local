<html>
    <div class="accessibility">
        <h1>Accessibility statement for <a href="https://collections.ed.ac.uk/public-art">Public Art website</a></h1>
        ...
        <p>This accessibility statement applies to  <a href="https://collections.ed.ac.uk/public-art">https://collections.ed.ac.uk/public-art</a></p>
        ...
        <ul>
            ...
            <li>zoom in up to 240% with reflow or loss of content;</li>
        ...
        <ul>
            ...
            <li>some body text is smaller than 12 point and uses all caps and serif fonts;</li>
            ...
            <li>Videos on the site do not contain appropriate human corrected captions;</li>
            ...
            <li>colour is used as a means of conveying information to the user;</li>
            ...
            <li>Some parts of the site are not able to be navigated to using voice recognition software;</li>
            <li>there are some instances of flashing or moving graphics;</li>
        ...
        <ul>
            ...
            <li>Content will only display in a single page orientation
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#orientation">1.3.4 - Orientation</a></li>
                </ul>
            </li>
            <li>Colour is used as the only visual means of conveying information, indicating an action, prompting a response, or distinguishing a visual element
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#use-of-colour">1.4.1 - Use of Color</a></li>
                </ul>
            </li>
            ...
            <li>Text cannot be resized without assistive technology up to 200 percent without loss of content or functionality
                <ul>
            ...
            <li>Content cannot be presented without loss of information or functionality, requiring the user to scroll in two dimensions
                <ul>
            ...
            <li>Users are not always able to pause, stop or hide moving items that appear at some points on the webpage
                <ul>
                    <li><a href="https://www.w3.org/TR/WCAG21/#pause-stop-hide">2.2.2 - Pause, Stop, Hide</a></li>
                </ul>
            </li>
            ...
            <li>Link purpose is not always clear and some adjacent links go to the same location
                <ul>
        ...
        <p>This website was first tested on 7th August 2020, reviewed on 15th September 2021 and then again on 7th October 2022. The testing was carried out by The University of Edinburgh Library and University Collections Digital Library Development team The August 2020 and September 2021 only consisted of automated <a href="https://wave.webaim.org/">Wave WEBAIM</a> and <a href="https://littleforest.co.uk/">Little Forest</a> testing tool. The testing in October 2022 included full manual as well as automated testing.</p>
