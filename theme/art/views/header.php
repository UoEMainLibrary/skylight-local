                ...
                <div class="header-logo">
                    <a href="">
                        <img class="header-img"
                            onmouseout="this.src='<?php echo base_url(); ?>/theme/art/images/UoE_Stacked-Logo_Blue-dark.png'"
                            onmouseover="this.src='<?php echo base_url(); ?>/theme/art/images/UoE_Stacked-Logo_Blue-light.png'"
                            src="<?php echo base_url(); ?>/theme/art/images/UoE_Stacked-Logo_Blue-dark.png">
                    </a>
                </div>
                    ...
                    <div class="container-fluid">
                        <div class="input-group">
                            <input type="text" class="form-control"
                                ...
                                aria-describedby="basic-addon2" name="q" value="<?php if (isset($searchbox_query))
                            ...
                            <div class="input-group-append">
                                ...
                                <input type="button" class="btn btn-outline-secondary" name="submit_search"
                                    value="Advanced Search" onclick="location.href='./advanced';" />
                            </div>
                        </div>
                    </div>
                </form>
