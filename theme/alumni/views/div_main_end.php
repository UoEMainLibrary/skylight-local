            ...
            <div class="footer-links">
                ...
                <div class="social-links">
                    <ul class="social-icons">
                        ...
                        <li><a href="https://www.flickr.com/photos/crcedinburgh" class="flickr-icon" target="_blank" onclick="return warnNewTab()" title="CRC on Flickr"></a></li>
                        <li><a href="http://libraryblogs.is.ed.ac.uk/" class="wordpress-icon" target="_blank" onclick="return warnNewTab()" title="L&UC Blogs"></a></li>
                    </ul>
                </div>
            </div>
