        <footer>
            <div class="footer-links">
                ...
                <div class="social-links">
                    <ul class="social-icons">
                        <li><a href="https://www.facebook.com/pages/Edinburgh-University-Collection-of-Historic-Musical-Instruments-EUCHMI/144892895544842" class="facebook-icon" target="_blank" onclick="return warnNewTab()" title="MIMEd on Facebook"></a></li>
                        <li><a href="https://twitter.com/MIMEdinburgh" class="twitter-icon" target="_blank" onclick="return warnNewTab()" title="MIMEd on Twitter"></a></li>
                    </ul>
                </div>
            </div>
            <div class="footer-disclaimer">
                ...
                <div class="recognised-logo">
                    <a href="https://www.museumsgalleriesscotland.org.uk/standards/recognition/" target="_blank" onclick="return warnNewTab()" class="recognisedlogo" title="Recognised Collection of National Significance Link"></a>
                </div>
            </div>
        </footer>
