    ...
    <div class="description">
                ...
                foreach($solr[$element] as $index => $metadatavalue) {
                    ...
                    if(in_array($key, $filters)) {
                        ...
                        if (stripos($element, "uri") !== FALSE)
                        {
                            ...
                            echo '<a title="URL Links for item" target="_blank" data-toggle="modal" data-target="#newTabNotice" data-href="' . $solr[$element][$n] . '">' . $solr[$element][$n] . '</a>';
        ...
        <div class="institution-logo row">
            ...
            if (isset($solr[$logoImageName]))
            {
                ...
                $LogoLink = '<a title="Link to Institution" target="_blank" data-toggle="modal" data-target="#newTabNotice" data-href="' . $institutionUri . '"><img src = "' . $t_uri . '" class="uni-thumbnail" /></a>';
