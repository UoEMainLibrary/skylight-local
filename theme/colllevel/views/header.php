        ...
        <div class="navbar-header">
            <div id="collection-title">
                ...
                <div id="navbar-smallword">
                    <a href="<?php echo base_url(); ?>/<?php echo $this->config->item('skylight_theme'); ?>" class="collectionswordsmall" title="University of Edinburgh Collections Home">Collections</a>
                </div>
            </div>
            ...
            <form action="./redirect/" method="post">
                <div class="icon-addon addon-lg">
                    <div class="input-group-btn">
                        <input type="text" placeholder="Search the Collections Directory" class="form-control" name="q" id="q" >
                        <label class="glyphicon glyphicon-search" rel="tooltip"></label>
                        <input type="submit" name="submit_search" class="btn" value="Search" id="submit_search" title="Search the Collections Directory" />
                    </div>
                </div>
            </form>
        </div>
