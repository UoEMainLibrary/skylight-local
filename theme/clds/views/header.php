    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right hidden-xs" id="navbar-right">
                <li><a href="https://www.facebook.com/crc.edinburgh" target="_blank" title="CRC Facebook Page" data-toggle="tooltip" data-trigger="focus"><i id="social-fb" class="fa fa-facebook-square fa-3x social" aria-hidden="true"></i> </a></li>
                <li><a href="https://twitter.com/CRC_EdUni" target="_blank" title="CRC Twitter Feed" data-toggle="tooltip" data-trigger="focus"><i id="social-tw" class="fa fa-twitter-square fa-3x social" aria-hidden="true"></i> </a></li>
                <li><a href="https://www.flickr.com/photos/crcedinburgh" target="_blank" title="CRC Flickr Page" data-toggle="tooltip" data-trigger="focus"><i id="social-fr" class="fa fa-flickr fa-3x social" aria-hidden="true"></i> </a></li>
                <li><a href="http://libraryblogs.is.ed.ac.uk/" target="_blank" title="University of Edinburgh Library Blogs" data-toggle="tooltip" data-trigger="focus"><i id="social-wp" class="fa fa-wordpress fa-3x social" aria-hidden="true"></i> </a></li>
            </ul>
        </div>
    </div>
</nav>
