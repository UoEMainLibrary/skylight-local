            ...
            <footer>
                <div class="col-md-9 col-sm-9 col-xs-12 footer-logos ">
                    <div class="center-block">
                        ...
                        <a href="https://libraryblogs.is.ed.ac.uk/resp/" target="_blank" title="RESP Instagram"><div class="blogs-logo"></div><span class="visually-hidden"> (opens in a new tab)</span></a>
                        <a href="https://www.instagram.com/RESParchiveproject/" target="_blank" title="RESP Instagram"><div class="instagram-logo"></div><span class="visually-hidden"> (opens in a new tab)</span></a>
                    </div>
                </div>
                <div class="col-sm-12 col-xs-12 footer-disclaimer">
                    <div class="center-block footer-policies">
                        ...
                        &nbsp;&nbsp;<a href="./accessibility" title="Website Accessibility Link" target="_blank">Accessibility (opens in a new tab)</a>
